        ...
        <section className='section_card'>
            ...
            <div className='container'>
                <div className='card_wrapper pt-2 pb-16 flex flex-col gap-2'>
                    ...
                    {
                        !isLoading ? <div className='cards grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3 '>
                            {
                            ...
                            :
                            <div className="w-full h-[29vh] flex items-center justify-center">
